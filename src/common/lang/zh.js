module.exports = {
  ...
  whatWeDo: {
    name: '下一代互联网',
    content: 'NKN是基于区块链构建互联网的新型网络的基础设施，旨在重建真正开放，去中心化，动态，安全，共享以及社区共同拥有的互联网。'
  },
  why: {
    tit: 'Why',
    name: '当前面临的问题',
  ...
  faqBackup: {
    name: 'FAQ',
    q1: 'NKN团队如何提出NKN概念？',
    a1: '在过去的几年里，我们一直参与区块链的开发，并完成了不少区块链系统。 不过，我们早在做区块链之前就一直在做去中心化的点对点网络研发。 例如基于WiFi的Mesh网络，以及一些实际的去中心化数据中继和传输系统的部署。\n' +
    '由于区块链的核心之一是去中心化的网络，我们一直在考虑如何更好地利用区块链的这一特性来解决空闲网络连接和传输能力的问题。 通过区块链的自我激励机制，有机会促进去中心化网络的不断发展和扩张。 与此同时，我们也看到目前没有区块链系统可以很好地实现网络资源的数字资产化。\n' +
    '那么，我们能否将这一点与我们的背景和专业知识结合起来呢？ 建立一个人人都可以参与并共同构建的网络系统？ 这将从根本上解决当今互联网的许多问题，如网络碎片化和网络中立性。 这就是创建NKN项目的初衷。',
    q2: '创始人李彦博简介',
    a2: '李彦博是NKN项目的创始人。 他喜欢编码，并在区块链和无线网络堆栈中完成了不少开源项目。 在过去两年中，他是OnChain的联合创始人和DNA（分布式网络架构）开源项目的核心开发人员。 他在北京和加利福尼亚带领了一批极具天赋的开发人员。 作为一种爱好，彦博喜爱通过拳击保持头脑和身体的良好状态！ 所以从某种意义上说，国外网友与其昵称彦博是区块链中的兰博基尼，不如称他是区块链中的兰博。',
    q3: 'NKN团队有多少人， 地理位置集中吗？',
    a3: 'NKN是一个雄心勃勃的项目，需要大量人才。NKN要实现目标并非需要一只庞大的软件工程师团队，而是由优秀的核心开发精英组成，通过开放源代码，导入社区开发者支持，并适时部分复用现有解决方案进行实现的。目前，NKN团队已经有10位开发人员，他们在区块链和网络软件堆栈方面拥有丰富的编程经验。我们的团队位于中美两国。此外，NKN还通过和美国知名大学合作解决一些技术问题，例如， 斯坦福大学迪菲博士的Cryptic Labs和NKN展开深度合作。他们致力于基础密码学和算法的发开。NKN并不需要重新发明基础理论，我们相信建立在巨人的肩膀上可以解决一些关键的技术难题。此外，李彦博之前在DNA中的代码库的积累可用于加速NKN最初原型开发和概念验证阶段的开发。无论如何，从长期来看，众多核心组件仍需要NKN团队从头编写。DNA开源项目为NKN提供了一个沙箱来做关键的新组件开发。除此之外，NKN还将努力构建一个充满活力的开源社区，社区开发人员可以为NKN开源项目贡献力量。对于社区开发者的付出，NKN将通过支付NKN令牌作为回报。',
    q4: '什么是元胞自动机？',
    a4: '元胞自动机是我们一直非常感兴趣的概念。通俗地说，它是一个使用简单规则为复杂系统建模的强大工具。它已经应用于神经网络，网络路由，密码学，以及人工智能领域。元胞自动机具有一些独特的特性，对于网络路由以及可扩展的共识算法非常有吸引力： \n' +
    '- 真正对等\n' +
    ' - 简单规则\n' +
    ' - 本地并行处理 \n' +
    '- 动态 \n' +
    '- 去中心化：本地决策，全局影响 \n' +
    '- 开放和可扩展\n' +
    '找到正确的规则和初始状态可以将系统分为四种状态。\n' +
    '第一类“同质和稳定”对于达成共识非常有用。\n' +
    '第四类“混沌边缘”，可以探索具有某种随机性的动态路由。\n' +
    '元胞自动机启发我们解决复杂的网络路由和共识问题。其特点是不通过对整个系统建模，而是集中于定义单个节点如何相互交互的简单规则。这是去中心化系统的本质，而元胞自动机概念恰如其分地适用于此。',
    q5: '如何将元胞自动机应用到NKN当中？',
    a5: '元胞自动机是一个概念和方法论，将指导NKN协议和系统的设计和实现。 所以它对于动态网络路由以及一致性算法会很有用。NKN的另外一个贡献是在物理中使用伊辛模型来数学证明元胞自动机规则是否收敛，并且在数学上指导我们找到合适的规则。 因此，我们不必在数百万条潜在规则中彻底搜索。',
    q6: 'NKN使用元胞自动机方法论的优点是什么？',
    a6: '基于元胞自动机的模型具有一些突出的特点，如真正的去中心化特性和节点之间的平等性。它们可以同时运行并且很容易扩展。以上这些功能非常符合NKN网络特点。同时，个体之间的交互规则简单易，有助于保证网络鲁棒性。\n' +
    '另外，元胞自动机的一些独特的特性对于网络路由以及可扩展的共识算法非常有吸引力：\n' +
    ' - 真正平等的对等个体：去中心化，不依赖种子或核心节点 \n' +
    '- 简单规则：易于实现，代码简单，错误少，消耗资源少，可用于大规模的移动设备 \n' +
    '- 本地并行处理：高度可扩展 \n' +
    '- 动态：网络拓扑结构可随着一点随机发展，难以检测网络流量模式，更能抵御攻击\n' +
    ' - 去中心化：本地决策，全球影响 \n' +
    '- 开放并且可扩展',
    q7: '去中心化应用程序如何与NKN进行互动？',
    a7: '去中心化应用通过NKN应用程序接口在网络层上实现网络连接和流量中继功能。另外，去中心化应用程序将与激励层进行交互，以进行结算或挖矿。所以去中心化应用程序既可以是NKN网络的消费者，也可以是服务提供商。未来，NKN将探索将协议作为通用的网络层提供给其他区块链系统。同时，NKN还将探索使用该网络作为去中心化应用程序发布自有令牌并编写自有智能合约的平台。但这些是NKN更长期的目标， 而NKN的短期目标是是将基础打造坚实。其中一个去中心化应用程序从NKN中受益的例子是真正的点对点消息应用。今天，由于我们大多数人都在使用私有IP地址和防火墙的NAT（网络地址转换），我们必须依靠中央服务器来中继消息，例如： WhatsApp，脸书 Messenger和电报。而通过使用NKN网络，消息传递应用程序可以从一开始就实现去中心化的点对点消息传递，而无需其自己的服务器基础架构。',
    q8: 'NKN中的去中心化数据传输网络是什么？',
    a8: 'NKN引入了去中心化数据传输网络（DDTN）的概念。 DDTN结合了多个独立和自组织的中继节点，为客户提供连接和数据传输能力。 这种协调是区中心化的，不需要双方彼此信任。 NKN的安全操作是通过共识机制来实现的，该机制协调并验证每个节点执行的操作。 DDTN为去中心化应用程序（dApp）提供了各种策略。与中心化网络连接和数据传输相比，DDTN节点之间有多条高效路径，可用于增强数据传输能力。NKN提供“自激励”机制， 本地令牌可以激励共享网络资源，并最终减少浪费的连接和带宽。',
    q9: 'NKN的基本目标是什么？',
    a9: '我们的口号很好地总结了NKN的基本目标“Free the bits, rebuild the Internet we always wanted”。 分解成更具体的目标：\n' +
    '我们要实现\n' +
    '- 在任何地方连接任何人\n' +
    ' - 从网络层保证网络中立\n' +
    ' - 保证互联网始终开放和可扩展\n' +
    '- 奖励资源共享并改善每个人的连接能力 \n' +
    '- 建立世界上最大的互联网带宽交易所',
    q10: '与其他网络项目相比，NKN的优势在哪里？',
    a10: '人们经常问我们，与网络领域的其他项目相比，NKN有什么不同。现有项目完全专注于手机，并使用Wi-Fi，蓝牙和Wi-Fi Direct。 NKN打算改变整个互联网，包括固定和移动，电话，笔记本电脑和核心网络。 NKN是一种独立于底层物理通信媒体的协议覆盖，对应用程序是透明的。\n' +
    '此外，大多数网络项目都基于以太坊，ERC-20令牌和智能合约。我们不确定以太坊是否可以扩展成百万或数十亿个节点，以及数PB的流量。 NKN将拥有自己的区块链技术，该技术将具有全新的中继证明和新的共识算法，这些算法将专门用于将网络传输能力进行数字资产化。\n' +
    '因此，与一些项目相比，NKN的范围更广。我们希望将网络资源数字资产化，就像IPFS对存储进行的操作一样。我们的目标是通过1万亿美元的通信业务，以及如何通过激励共享未使用的网络资源，扩大和升级共享网络，为每个人提供更好的连接。',
    q11: 'NKN是否需要一个庞大的社区',
